...
const services = [
  ...
  },
  {
    ...
    description:
      "Custom ML models to extract valuable insights from your data.",
  },
  {
    icon: BarChart,
      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="text-gray-400">
            We offer a wide range of AI & Software consulting services to help
            businesses harness the power of artificial intelligence and stay
